    ...
    <body>
        <section class="properties container" id="properties">
            ...
            <div class="properties-container container">
                ...
                <?php
            $cat_id = $_GET['id'];
            $rows = mysqli_query($conn, "SELECT * FROM user_services WHERE cat_id = '$cat_id' AND status ='done' ");
            ...
            ?>
                <!-- ============ MODAL ============== -->
                <div class="modal fade" id="DetailsModal" tabindex="-1" aria-labelledby="More DetailsModal"
                    aria-hidden="true">
