            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <form class="row g-3" method="POST" action="" enctype="multipart/form-data">
                        <div class="modal fade" id="cardInfo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="input-group mb-4">
                                            <label class="input-group-text" for="inputGroupFile01">Select
                                                Image</label>
                                            <input type="file" class="form-control" id="inputGroupFile01" name="image" accept=".jpg, .jpeg, .png">
                                        </div>
                                        ...
                                        <div class="col-12  mb-4">
                                            ...
                                            <input type="text" class="form-control" id="inputAddress" placeholder="" name="details">
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <a class="btn" data-bs-target="#contactForm" data-bs-toggle="modal" data-bs-dismiss="modal">Next</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!-- Modal 2-->
                        <div class="modal fade" id="contactForm" tabindex="-1" aria-labelledby="exampleModalLabe2" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row-6  mb-4">
                                            ...
                                            <input type="text" class="form-control" id="inputAddress" placeholder="" name="phone_number">
                                        </div>
                                        <div class="modal-footer">
                                        ...
                                        <a class="btn" data-bs-target="#cardInfo" data-bs-toggle="modal" data-bs-dismiss="modal">Back</a>
                                    </div>
                                </div>
                            </div>
                        </div>
